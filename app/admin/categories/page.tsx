                                        ...
                                        <tr key={cat.id} className="group hover:bg-violet-50/40 transition-colors">
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="font-bold text-zinc-700">{cat.createdByName || cat.createdBy || "Admin"}</span>
                                                    {/* Role Badge */}
                                                    <span className={`text-[10px] px-2 py-0.5 rounded-full font-bold uppercase
                                                        ${(cat.createdByRole || "").toUpperCase() === "ADMIN"
                                                            ? "bg-fuchsia-100 text-fuchsia-600"
                                                            : "bg-emerald-100 text-emerald-600"
                                                        }`}>
                                                        {cat.createdByRole === "ROLE_TEACHER" ? "Teacher" : (cat.createdByRole || "Admin")}
                                                    </span>
                                                </div>
                                            </td>
